...
//        _familyMoviesState.value = ScreenState.Loading
//        try{
//            val response = KinopoiskApi.retrofitService.getFamily()
//            if(response.isSuccessful){
//                _familyMoviesState.value = ScreenState.Success(response.body()?.movies ?: emptyList())
//            }
//            else{
//                _familyMoviesState.value = ScreenState.Error("Failed to fetch premieres")
//            }
//        } catch (e: Exception) {
//            _familyMoviesState.value = ScreenState.Error("Network error")
//        }
//
//    }

    // Similar updates for fetchCollections, fetchZombies, and fetchFamily methods
}
